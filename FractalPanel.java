...
public class FractalPanel extends JPanel {
	...
	/**
	 * Recursive method to draw a koch line on the panel with three parameters.
	 * Precondition: if the level is equal to zero, verifies if the line is valid and then call the method draw line on the panel. 
	 * Otherwise, calls itself passing g2, the level less one and the line A, B, C and D.
	 * Postcondition: draw a line on the panel according to the verifications in this method.
	 * @param g2 Graphics2D
	 * @param level int
	 * @param line KochLine
	 */
